pipeline {
    ...
    environment {
        ...
        GRADLE_OPTS = '-Xmx1024m -Dorg.gradle.daemon=false -Dorg.gradle.parallel=false -Dorg.gradle.workers.max=1 -Dnet.bytebuddy.experimental=true -Dorg.gradle.workers.max=2'
